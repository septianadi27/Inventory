                        ...
                        <div class="card card-body">
                            <div class="row">
                                    ...
                                    <div class="col-md-8 text-right d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                                            <button type="button" data-toggle="modal" data-target="#info-header-modal"
                                            ...
                                            <tr>
                                                ...
                                                <td><div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                                                        <a class="dropdown-item" href="edit.php?kode=<?php echo $data['kode_barang']; ?>">Edit</a>
                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            <div class="modal-header modal-colored-header bg-info">
                                <h4 class="modal-title text-white" id="info-header-modalLabel">Tambah Barang</h4>
